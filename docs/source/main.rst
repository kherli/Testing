...
.. figure:: frog.jpg
   :alt: This frog was uploaded via the file-tree menu.
   :name: fig:frog

   This frog was uploaded via the file-tree menu.
...
like this: (Greenwade 1993). Just remember to specify a bibliography
